(function(){
//Objeto con propiedad de formulario//
var propFormulario = {
    forumulario: document.formulario_contacto,
    elementos: document.formulario_contacto.elements,
    error: null,
    textoError: null
}
//Objeto con método de formulario//
var metFormulario = {
	inicio: function(){
		...
		propFormulario.forumulario.addEventListener('submit', metFormulario.validarInputs);
	},
	focusInput: function () {
